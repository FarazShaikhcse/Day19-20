...
/**
 * @author farazshabbir
 * This class will implement a hash table for the input data given as a file
 * @param <T>
 */
public class Hashing<T> {
	...
	/**
	 * @param data=new data to be added to hash table
	 * this method calculates the hash index using modulus and then the data is added to that index
	 *                
	 */
	...
	public void write() {
		try {
			...
			FileWriter fWriter = new FileWriter("/Users/farazshabbir/eclipse-workspace/Day19_20/OutputData/Hashing.txt");
	...
	public static void main(String[] args) {
		try {
			...
			File file = new File("/Users/farazshabbir/eclipse-workspace/Day19_20/Data/Hashing.txt");
