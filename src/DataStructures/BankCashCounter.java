...
/**
 * @author farazshabbir
 *this class simulates the bank cash counter where there is a queue
 */
public class BankCashCounter {
	...
	/**
	 * @param n is the number of at counter queue
	 * this method asks the user at the queue to either deposit or withdraw
	 */
		...
		while (num != n) {
			...
			while (!done) {
				...
				case 1:
					...
					queue.dequeue();
					num++;
					System.out.println("Person " + (num) +" available cash:" + cash);
					break;
				case 2:
